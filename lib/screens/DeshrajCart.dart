...
class DeshrajCart extends StatefulWidget {
  final Food food;
  final Function updateTotal;
  final Function delete;
  DeshrajCart({ this.food, this.delete, this.updateTotal});

  @override
  _DeshrajCartState createState() => _DeshrajCartState();
}

class _DeshrajCartState extends State<DeshrajCart> {
  @override
