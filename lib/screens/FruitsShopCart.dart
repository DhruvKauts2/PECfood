...
class JuiceCornerCart extends StatefulWidget {
  final Food food;
  final Function updateTotal;
  final Function delete;
  JuiceCornerCart({ this.food, this.delete, this.updateTotal});

  @override
  _JuiceCornerCartState createState() => _JuiceCornerCartState();
}

class _JuiceCornerCartState extends State<JuiceCornerCart> {
  @override
