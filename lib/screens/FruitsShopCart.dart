...
class FruitsShopCart extends StatefulWidget {
  final Food food;
  final Function updateTotal;
  FruitsShopCart({ this.food, this.updateTotal});

  @override
  _FruitsShopCartState createState() => _FruitsShopCartState();
}

class _FruitsShopCartState extends State<FruitsShopCart> {
  @override
